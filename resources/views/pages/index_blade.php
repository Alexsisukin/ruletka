...
<?php
$spisok = array('<img src="/images/cheapkey/Ace_of_Spades.jpg" alt="Ace of Spades" />', '<img src="/images/cheapkey/Far_Cry_4.jpg" alt="Far Cry 4" />');

?>
<div class="rulet_full full">
    <div class="rulet_title"><b><em></em> </b> <span></span>
    </div>
    <div class="rulet_btn" id="button_buy"><span>ИСПЫТАТЬ УДАЧУ</span> <b>59 руб.</b>
    </div>
    ...
    <div class="rulet">
        <ul>
            <?php
                echo '<li>'.$spisok[mt_rand(0,count($spisok)-1)].'</li>';
            ?>
            <li><img src="/images/cheapkey/Ace_of_Spades.jpg" alt="Ace of Spades" />
            </li>
            <li><img src="/images/cheapkey/Far_Cry_4.jpg" alt="Far Cry 4" />
            </li>
            <li><img src="/images/cheapkey/149.jpg" alt="Случайная игра" />
            </li>
            <li><img src="/images/cheapkey/ex.jpg" alt="Deus Ex: Manking Devided" />
            </li>
            <li><img src="/images/cheapkey/149.jpg" alt="Случайная игра" />
            </li>
    ...
    <div class="item_loop">
        ...
        @foreach($cases as $case)
            <div class="item" data-id="{{$case->id}}">
                ...
                <div class="item_rub"><b>{{$case->price}}</b> руб</div>
                <div class="item_images">
                    <a href="case/{{$case->id}}" class="item_open">Открыть</a>
