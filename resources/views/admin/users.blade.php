...
<div class="well no-padding">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>{{$i->login}}</td>
            <td>{{$i->money}}</td>
            <td>@if($i->is_admin)<span class="label label-danger">Да</span>@else <span class="label label-success">Нет</span>
                @endif
            </td>
            <td>@if($i->is_yt)<span class="label label-danger">Да</span>@else <span class="label label-success">Нет</span>
                @endif
            </td>
